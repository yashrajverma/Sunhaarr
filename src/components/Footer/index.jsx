...
const navigation = {
    categories: categories.filter((item) => item.type === 'category'),
    support: [
        { name: 'Pricing', href: '#' },
...
export default function Footer() {
    return (
        <footer className="bg-softPeach" aria-labelledby="footer-heading">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                <div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
                    <div className="grid grid-cols-2 gap-8 xl:col-span-4">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div className="mt-12 md:mt-0">
                                <h3 className="text-sm font-bold text-primaryNavy tracking-wider uppercase">Support</h3>
                                <ul role="list" className="mt-4 space-y-4">
                    ...
                    <div className="mt-12 xl:mt-0">
                        <h3 className="text-sm font-bold text-primaryNavy tracking-wider uppercase">Language &amp; Currency</h3>
                            ...
                            <fieldset className="w-full">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="pointer-events-none absolute inset-y-0 right-0 px-2 flex items-center">
                                        <Icon iconName="chevrondown" className="h-4 w-4 text-white" aria-hidden="true" />
                                    </div>
                                </div>
                            </fieldset>
                ...
                <div className="border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
                    <div>
                        <h3 className="text-sm font-bold text-primaryNavy tracking-wider uppercase">
                    ...
                    <form className="mt-4 sm:flex sm:max-w-md lg:mt-0">
                        ...
                        <input
                            ...
                            autoComplete="email"
                            required
                            className="appearance-none min-w-0 w-full bg-white border border-transparent  py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white focus:border-white focus:placeholder-gray-400 sm:max-w-xs"
                ...
                <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
                    <div className="flex space-x-6 md:order-2">
                        {navigation.social.map((item) => (
                            <a key={item.name} href={item.href} className="text-primaryNavy hover:text-gray-300">
                                <span className="sr-only">{item.name}</span>
                                <item.icon className="h-6 w-6" aria-hidden="true" />
                            </a>
                        ))}
                    </div>
                    <p className="mt-8 text-base text-primaryNavy md:mt-0 md:order-1">
